...
RUN git clone https://gitee.com/mirrors_hyperledger-labs/chaincode-analyzer.git /srv/chaincode/chaincode-analyzer/
WORKDIR /srv/chaincode/chaincode-analyzer
RUN ls -al
RUN go mod init github.com/hyperledger-labs/chaincode-analyzer
